            ...
            <div class="flex flex-col gap-5">
                ...
                <div class="bg-white flex flex-col gap-5 p-5 rounded-[20px] h-fit">
                    ...
                    <div class="w-full bg-[#030303] flex items-center gap-[10px] p-[10px_14px] rounded-xl">
                        <div class="w-5 h-5 flex shrink-0">
                            <img src="assets/icons/story.svg" alt="icon">
                        </div>
                    ...
                    <form action="" class="flex flex-col gap-5">
                        <div class="flex p-[14px_20px] border border-[#030303] rounded-[20px] gap-[10px]">
                            <div class="w-6 h-6 flex shrink-0">
                                <img src="assets/icons/sms-star.svg" alt="icon">
                            </div>
                            <textarea name="experience" id="" rows="8" class="focus:outline-none appearance-none font-medium leading-[30px] placeholder:font-normal placeholder:text-[#545768] w-full resize-none" placeholder="Write your experience related to this project"></textarea>
                        </div>
                        <div class="flex flex-col sm:flex-row gap-3 items-center">
                            ...
                            <button class="font-semibold bg-[#6635F1] p-[14px_20px] rounded-full text-center w-full text-white">Apply Now</button>
                        </div>
                    </form>
                </div>
            </div>
